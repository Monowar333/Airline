...
public class LocaleUtil {
	...
	private static final ResourceBundle resourceBundle_EN = ResourceBundle
			.getBundle("resources", EN_LOCALE);
	private static final ResourceBundle resourceBundle_RU = ResourceBundle
			.getBundle("resources", RU_LOCALE);
	...
	public static String getValueByKey(String key, HttpSession session) {
		if (key != null && session != null) {
			...
			LOG.info("key or session == null; key: " + key + "; session: "
					+ session);
			return null;
		}
	}
